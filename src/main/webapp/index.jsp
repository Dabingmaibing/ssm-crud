	      ...
	      <div class="modal-body">
	        <form class="form-horizontal">
			  ...
			  <div class="form-group">
			    ...
			    <div class="col-sm-10">
			      <input type="text" name="email" class="form-control" id="email_update_input" placeholder="email@zhu.com">
	      ...
	      <div class="modal-body">
	        <form class="form-horizontal">
			  ...
			  <div class="form-group">
			    <label class="col-sm-2 control-label">email</label>
			    <div class="col-sm-10">
			      <input type="text" name="email" class="form-control" id="email_add_input" placeholder="email@zhu.com">
			      <span class="help-block"></span>
			    </div>
			  </div>
			  <div class="form-group">
